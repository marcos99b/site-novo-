    ...
    <div className="fixed z-[60] bottom-6 right-6">
      {!open && (
        <button
          ...
          className="group relative shadow-2xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 border-0 rounded-full w-16 h-16 grid place-items-center text-white hover:scale-110 transition-all duration-300 transform hover:rotate-3"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <div className="text-blue-100 text-xs sm:text-sm">Online • Resposta em segundos</div>
                </div>
              </div>
              <button 
                type="button" 
            ...
            <div className="flex justify-start">
              <div className="max-w-[90%] sm:max-w-[85%] bg-white border border-gray-200 rounded-2xl rounded-tl-md p-3 sm:p-4 shadow-sm">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 grid place-items-center">
            ...
            {topic === 'root' ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  {options.map((o) => (
                    <button
                      ...
                      className="p-3 sm:p-4 rounded-xl border border-gray-200 bg-white hover:border-blue-300 hover:shadow-md text-left transition-all duration-200 group"
                    >
                      <div className="text-xl sm:text-2xl mb-2">{o.icon}</div>
                      <div className="text-xs sm:text-sm font-medium text-gray-700 group-hover:text-blue-600">{o.label.replace(o.icon + ' ', '')}</div>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <>
                ...
                <div className="flex gap-2 sm:gap-3">
                  ...
                  <button 
                    type="button" 
                    className="px-3 sm:px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs sm:text-sm hover:from-blue-700 hover:to-purple-700 transition-all duration-200" 
                    onClick={() => setOpen(false)}
                  >
                    Fechar
                  </button>
            ...
            <div className="border-t border-gray-200 pt-3 sm:pt-4">
              <div className="flex gap-2 sm:gap-3">
                <input
                  ...
                  className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-xl text-gray-700 placeholder-gray-400 text-xs sm:text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200"
                />
                <button
                  onClick={handleSendMessage}
                  disabled={!userMessage.trim() || isTyping}
                  className="px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
