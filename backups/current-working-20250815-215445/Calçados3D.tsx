...
interface Calçados3DProps {
  className?: string;
}

export default function Calçados3D({ className = '' }: Calçados3DProps) {
  ...
  useEffect(() => {
    ...
    loader.load(
      '/models/textured.glb', // Usando a versão com texturas
      (gltf) => {
        ...
        const scale = 3.2 / maxDim; // Escala bem maior para calçados ficarem muito visíveis
