...
async function testeSistemaReal() {
  console.log('🧪 TESTE DO SISTEMA REAL');
  console.log('=========================\n');
  ...
  try {
    ...
    const testEmail = `teste-real-${Date.now()}@techgear.com`;
    ...
    // 3. Simular o que o AuthContext fará - criar lead e customer
    console.log('\n3. Criando lead e customer...');
    ...
    // 5. Verificar dados no CRM
    console.log('\n5. Verificando dados no CRM...');
