...
-- Execute este SQL no Supabase Dashboard: https://supabase.com/dashboard/project/ljfxpzcdrctqmfydofdh/sql
...
AND table_name IN ('leads', 'customers', 'orders', 'products', 'product_views', 'user_events');
